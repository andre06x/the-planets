        ...
        <div className="d-flex justify-content-between">
          ...
          <div className="ms-md-5">
            ...
            <div className="d-flex flex-column mt-3 font-antonio fw-bold">
              <button className="btn text-light btn-outline-primary mb-3">01 Overview</button>
              <button className="btn text-light btn-outline-primary mb-3">02 INTERNAL STRUCTURE</button>
              <button className="btn text-light btn-outline-primary mb-3">03 SURFACE GEOLOGY
              </button>
            </div>
          </div>
        </div>
