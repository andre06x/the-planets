...
const Container = () => {
  ...
  return (
    <div className="container mt-5 flex-sm-column-reverse">
      <div className="d-flex flex-column">
        <div className="d-flex flex-sm-row-reverse justify-content-between">
          <div className="me-5">
            <img src={imagee}alt="" />
          </div>
          <div className="ms-md-5 d-flex flex-sm-column-reverse">
