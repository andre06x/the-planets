...
const Container = () => {
  ...
  const [imageGeology, setImageGeology] = useState('');
  ...
  function buttonChange(o) {
    ...
    if (o.id === 3) {
      ...
      setImagee(data.filter(d => d.name === planet)[0].images.planet);
      setImageGeology(data.filter(d => d.name === planet)[0].images.geology);
    }
    ...
    <div className="container mt-md-5">
      <div className="d-flex flex-column">
        <div className="d-flex flex-md-row flex-column-reverse justify-content-between">
          <div className="me-md-5 d-flex justify-content-center position-relative col-md-3">
            <img src={imagee} className="w-100 w-md-100" alt="" />
            <img src={imageGeology} alt="" className="position-absolute w-25 top-50 start-50 translate-middle"/>
          </div>
          <div className="ms-md-5 d-flex flex-md-column flex-column-reverse">
            ...
            <p className="lead text-muted font-antonio text-center" id="text">
              {text.content}
            </p>
            <span className="text-secondary">
              Source: <a href="#a" className="text-secondary"> Wikipédia</a>
            </span>
