...
const Container = () => {
  ...
  return (
    <div className="container mt-5">
      ...
      <div className="row">
        <div class="col-md-3 bg-transparent border">
          <div class="">
            <h6 class="">ROTATION TIME</h6>
            <p class="card-text text-light font-antonio">0.99 days.</p>
          </div>
        </div>
        <div class="card col-md-3 bg-transparent border">
          <div class="card-body">
